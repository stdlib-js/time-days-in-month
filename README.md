...
```javascript
import daysInMonth from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-days-in-month@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/time-days-in-month/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/time-days-in-month/actions/workflows/test.yml?query=branch:v0.2.2
